...
equation
  ...
  connect(Boundary_fixed3.port, pump11.port_a) annotation (Line(points={{28,34},
          {16,34}}, color={0,127,255}));
  connect(CHWR_Primary_Pump.port_a, tankMB.PortA) annotation (Line(points={{-38,
          18},{-46,18},{-46,-6.86},{-5,-6.86}}, color={0,127,255}));
