...
equation
  ...
  connect(u[2], pump1_m_flow_gain1.u)
                                   annotation (Line(points={{-90,17.5},{-58,
          17.5},{-58,76},{92,76},{92,52},{88.8,52}}, color={0,0,127}));
  ...
  connect(add3.u2, cooling_Tower.P) annotation (Line(points={{51.5,66.8},{45.75,
          66.8},{45.75,62.2},{33,62.2}}, color={0,0,127}));
  connect(add3.u1, add1.y) annotation (Line(points={{51.5,63.2},{51.5,49.6},{
          46.5,49.6},{46.5,46.3}}, color={0,0,127}));
  connect(add3.y, P) annotation (Line(points={{57.25,65},{77.625,65},{77.625,60},
  ...
  connect(T_CHWS.T, y[1]) annotation (Line(points={{48,17.6},{75.5,17.6},{75.5,
          15},{106,15}}, color={0,0,127}));
  connect(Twb, cooling_Tower.Twb) annotation (Line(points={{-90,60},{-40,60},{
          -40,66},{10.2,66}}, color={0,0,127}));
  connect(cooling_Tower.CWS, pump12.port_a) annotation (Line(points={{32.8,58},
