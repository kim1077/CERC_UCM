...
model Chiller "Chiller Model Using Buildings Package"
  ...
  Real ChillerCapFTemp(nominal=1, start=1)
    "cooling capacity factor function of temperature curve";
  Real ChillerEIRFTemp(nominal=1, start=1)
    "power input to cooling capacity ratio function of temperature curve";
  Real ChillerEIRFPLR(nominal=1, start=1)
    "power input to cooling capacity ratio function of part load ratio";
  Real PLR1(nominal=1, start=1) "Part Load Ratio";
  Real PLR2(nominal=1, start=1) "Part Load Ratio";
  Real CCR(nominal=1, start=1) "Chiller Cycling Ratio";
  Modelica.SIunits.HeatFlowRate Qavail(nominal=Qref,start=Qref)
    "Rated Capacity";
  Modelica.SIunits.HeatFlowRate Qevap(nominal=Qref,start=Qref)
