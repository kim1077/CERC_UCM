...
model Test_ChillerPlant8b
  ...
  Modelica.Blocks.Sources.Trapezoid trapezoid(
    ...
    falling=3600,
    amplitude=-0.9999,
    width=64000)       annotation (Placement(transformation(extent={{-88,22},{
            -72,34}}, rotation=0)));
  Modelica.Blocks.Sources.Trapezoid trapezoid1(
    ...
    amplitude=0,
    offset=293.75)
                annotation (Placement(transformation(extent={{-90,54},{-74,66}},
          rotation=0)));
equation
  ...
  connect(campus.CHWS, CHWS_Secondary_Pump.port_b) annotation (Line(points={{
          -13.2,-48.5},{-10.6,-48.5},{-10.6,-49},{-6,-49}}, color={0,127,255}));
  connect(campus.CHWR, CHWR_splitter.port_2) annotation (Line(points={{-30.8,
