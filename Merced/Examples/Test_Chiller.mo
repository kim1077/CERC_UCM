...
model Test_Chiller
  ...
  Modelica_Fluid.Sources.PrescribedBoundary_pTX FixedBC2(
    ...
    p=0,
    T=273 + 5)
    annotation (Placement(transformation(extent={{-58,-50},{-44,-36}}, rotation=
           0)));
...
equation
  ...
  connect(FixedBC2.port,Chiller. port_b2) annotation (Line(points={{-44,-43},{
          -44,-42},{-18,-42},{-18,-42.8}}, color={0,127,255}));
