...
model ModelValidDymola
  ...
  Modelica.Blocks.Sources.CombiTimeTable weather(
    ...
    fileName="J:\\work\\SEEDprojects\\Merced\\data.mat")
                             annotation (Placement(transformation(extent={{-55,
            34},{-40,44}}, rotation=0)));
  ...
  Modelica.Blocks.Sources.CombiTimeTable ControlInput(
    ...
    startTime=0) "CT_Tref//mdot_CHWS//T_CHWS_ref"
                             annotation (Placement(transformation(extent={{-71,
            2},{-56,12}}, rotation=0)));
equation
  connect(weather.y,centralPlant. w) annotation (Line(points={{-39.25,39},{
          -17.3,39},{-17.3,16.8},{-7.6,16.8}}, color={0,0,127}));
  connect(ControlInput.y, centralPlant.u) annotation (Line(points={{-55.25,7},{
          -29.625,7},{-29.625,7.6},{-7.6,7.6}}, color={0,0,127}));
