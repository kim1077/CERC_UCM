...
equation
  ...
  connect(tow1.TAir, wetBulTem1.TWetBul) annotation (Line(points={{-14,4},{-14,
          60},{-45,60}}, color={0,0,127}));
  ...
  connect(tow1.y, gain.y) annotation (Line(points={{-14,8},{-31.4,8}}, color={0,
          0,127}));
