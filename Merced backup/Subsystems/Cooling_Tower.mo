...
Buildings.HeatExchangers.CoolingTowers.YorkCalc tow1(
  ...
  Modelica.Blocks.Sources.Sine TOut(
    amplitude=5,
    offset=298.15,
    freqHz=1/86400) "Outside air temperature" 
  ...
  inner Modelica_Fluid.Ambient ambient annotation (extent=[18,22; 38,42]);
...
equation 
  ...
  annotation (Diagram, Icon(
      ...
      Line(points=[60,100; 60,20], style(
          ...
          rgbfillColor={0,0,255},
          fillPattern=1))));
  connect(tow1.TAir, wetBulTem1.TWetBul) annotation (points=[-14,4; -14,60;
        -45,60],
             style(color=74, rgbcolor={0,0,127}));
  ...
  connect(phi.y, wetBulTem1.phi) annotation (points=[-20.9,68; -30,68; -30,
        67; -45,67],
                 style(color=74, rgbcolor={0,0,127}));
  connect(tow1.y, gain.y) annotation (points=[-14,8; -31.4,8],
             style(color=74, rgbcolor={0,0,127}));
