...
*/
  ...
  parameter Real tauBuoy=9.81*.25 "rate of decay of buoyancy mixing";
...
//  SI.EnthalpyFlowRate QAB=Keff*TankCA*(TwB-TwA)*2/(heightA+heightB);
  ...
  Modelica.Blocks.Interfaces.RealInput Tamb( redeclare type SignalType = 
        Modelica.SIunits.Temperature) "ambient temperature" 
    annotation (extent=[-86,27; -60,53]);
