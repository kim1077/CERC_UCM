model Test_ChillerPlant8b 
  ...
  Subsystems.Cooling_Tower2w cooling_Tower(
  ...
  Modelica.Blocks.Sources.Trapezoid trapezoid(
    ...
    falling=3600,
    amplitude=-0.9999,
    width=64000)       annotation (extent=[-88,22; -72,34]);
...
equation 
  ...
  connect(campus.CHWS, CHWS_Secondary_Pump.port_b) annotation (points=[-13.2,
        ...
        rgbcolor={0,127,255}));
  connect(campus.CHWR, CHWR_splitter.port_2) annotation (points=[-30.8,
        -48.5; -44,-48.5; -44,-4.4; -43,-4.4],
                                      style(color=69, rgbcolor={0,127,255}));
  connect(cooling_Tower.CWR, CWR_Pipe.port_b) annotation (points=[-21.2,56; -30,
        56; -30,48],     style(color=69, rgbcolor={0,127,255}));
  ...
  connect(pump12.port_a, cooling_Tower.CWS) annotation (points=[26,34; 26,56;
        1.2,56],     style(color=69, rgbcolor={0,127,255}));
  connect(campus.m_flow, CHWS_Secondary_Pump.m_flow_in) annotation (points=[-31.04,
